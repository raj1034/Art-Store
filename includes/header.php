...
<header>
    <div class="ui attached stackable grey inverted  menu">
        <div class="ui container">
		    ...
		    <?php 
		      if(isset($_SESSION['numberOfFavoritePaintings']) && $_SESSION['numberOfFavoritePaintings'] >= 0) {
		        echo '<span class="ui red mini label">' . $_SESSION['numberOfFavoritePaintings'] . '</span>';
		      }
		    ?>
                </a>        
                <a class=" item">
